...
function! TTrCodeAssistor_Start() "{{{3
	if s:TTrCodeAssistor_isStart == 0
		...
		silent! nnoremenu <silent> &myPlugin.&TTrCodeAssistor.*Star&t :call TTrCodeAssistor_Start()<CR>
		silent! nnoremenu <silent> &myPlugin.&TTrCodeAssistor.\ Sto&p  :call TTrCodeAssistor_Stop()<CR>

		silent! nunmenu &myPlugin.&TTrCodeAssistor.\ Star&t
		silent! nunmenu &myPlugin.&TTrCodeAssistor.*Sto&p
...
if g:TTrCodeAssistor_AutoStart == 1
	...
	"make menu
	silent! nnoremenu &myPlugin.&TTrCodeAssistor.\ Star&t :call TTrCodeAssistor_Start()<CR>
	silent! nnoremenu &myPlugin.&TTrCodeAssistor.*Sto&p  :call TTrCodeAssistor_Stop()<CR>
endif
" ****************** }}}2
